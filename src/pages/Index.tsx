...
import {
  ...
  CheckCircle, ArrowRight, Zap, Users, Award, Clock
} from "lucide-react";
...
const services = [
  { title: "Web Development", description: "Custom web applications and platforms built with modern frameworks for speed, scale, and conversion.", icon: Globe, slug: "web-development" },
  { title: "Cybersecurity", description: "Protect your business with enterprise-grade security audits, monitoring, and incident response.", icon: Shield, slug: "cybersecurity" },
  { title: "IT Support", description: "Proactive, reliable managed IT support that keeps your operations running 24/7.", icon: Headphones, slug: "it-support" },
  { title: "Consulting", description: "Strategic technology advisory to align your IT investments with business goals.", icon: Brain, slug: "consulting" },
  { title: "Managed Hosting", description: "High-performance, fully managed hosting infrastructure with 99.9% uptime.", icon: Server, slug: "managed-hosting" },
  { title: "Domain Management", description: "Complete domain lifecycle management — registration, DNS, SSL, and renewals.", icon: Link2, slug: "domain-management" },
];

const projects = [
  { title: "Techlam Energy", category: "Energy Sector", description: "Complete digital transformation including dashboard, analytics platform, and customer portal.", image: projectTechlam },
  { title: "E-Commerce Platform", category: "Retail", description: "High-conversion online store with custom product configurator and payment integration.", image: projectEcommerce },
  { title: "Security Operations Center", category: "Cybersecurity", description: "Real-time threat monitoring dashboard for a financial services firm.", image: projectSecurity },
];

const testimonials = [
  { quote: "Vintech transformed our entire digital presence. Their team understood our vision from day one and delivered beyond expectations.", name: "Sarah Chen", role: "CTO", company: "Techlam Energy" },
  { quote: "The cybersecurity audit they conducted saved us from a potential breach. Professional, thorough, and worth every penny.", name: "Marcus Rodriguez", role: "Director of IT", company: "FinCore Systems" },
  { quote: "Their managed hosting solution cut our downtime by 99%. We haven't looked back since switching to Vintech.", name: "Emily Okafor", role: "Operations Manager", company: "Nexus Retail" },
];
  ...
  <Layout>
      ...
      <div className="relative container-wide px-4 sm:px-6 lg:px-8 py-32">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              to="/services"
              className="btn-outline text-primary-foreground border-primary-foreground/30 hover:bg-primary-foreground/10 text-base px-8 py-4"
            >
              Our Services
            </Link>
          </div>
    ...
    <SectionWrapper dark>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        <StatsCounter value={50} suffix="+" label="Projects Delivered" />
        <StatsCounter value={30} suffix="+" label="Happy Clients" />
    ...
    <SectionWrapper dark>
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-primary-foreground/70 mb-8">
          Let's discuss how Vintech can help you build, secure, and scale your technology.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <Link to="/get-quote" className="btn-primary text-base px-8 py-4">
            Get a Free Quote <ArrowRight size={18} className="ml-2" />
          </Link>
          <Link to="/contact" className="btn-outline text-primary-foreground border-primary-foreground/30 hover:bg-primary-foreground/10 text-base px-8 py-4">
            Contact Us
          </Link>
        </div>
      </div>
